        ...
        var opts = jQuery.extend( {
            ...
            ajaxUrl: ( typeof ajaxurl != 'undefined' )
                ...
                : ( ( typeof ajaxUrl != 'undefined' )
                    ? ajaxUrl // wp_localize_script('fw-form-helpers', 'fwAjaxUrl', admin_url( 'admin-ajax.php', 'relative' ));
    ...
    frontend: {
        ...
        renderFlashMessages: function ( flashMessages ) {
            ...
            jQuery.each( flashMessages, function ( type, messages ) {
                ...
                jQuery.each( messages, function ( messageId, message ) {
                    typeHtml.push( '<li class="fw-flash-message"><h2>' + message + '</h2></li>' );
                } );
    ...
    fwForm.initAjaxSubmit( {
        ...
        onSuccess: function ( elements, ajaxData ) {
            ...
            if ( isAdmin ) {
                ...
                var redirect_page = elements.$form.parents( '.crumina-module' ).data( 'redirect-page' );
                var redirect_target = elements.$form.parents( '.crumina-module' ).data( 'redirect-target' );
